    ...
    public static void main(String[] args) throws IOException{
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                double updatebprice = (0.1 * bprice) + bprice;
                System.out.println("Book price Actual :"+bprice);
                System.out.println("After Updated :"+updatebprice);
                
                String bsuj = rs.getString(4);
